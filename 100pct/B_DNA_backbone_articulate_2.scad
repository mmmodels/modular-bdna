/*
This script generates a backbone piece with articulation for B-DNA related models (with C2'-endo sugar pucker)

Articulation location: C3-O, C4-C5
...
include <./junctions/base_back_duckbill.scad>
include <./junctions/back_back_junction.scad>
include <./junctions/permanent_junction.scad>
...
echo(norm([2.0177, -0.5536, 7.0175] - [1.5599, -2.9009, 4.2117]));