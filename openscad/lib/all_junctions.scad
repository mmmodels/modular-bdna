/*
The modules in this script generate standalone junctions used by the molecule models. They are mapped onto the models using the aff_tran() function in "affine_transformation.scad".
